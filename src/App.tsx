...
const WA_LINK = "https://wa.me/917498593746?text=Hi%20Bliss%20Cake!%20%F0%9F%8E%82%20I'd%20like%20to%20place%20a%20cake%20order.%20Please%20share%20more%20details!"
                ...
                <div className="p-3 md:p-4">
                  ...
                  <div className="flex items-center justify-between gap-1">
                    ...
                    <div className="flex flex-col items-end gap-0.5">
                      <button className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white text-xs md:text-sm font-semibold px-2.5 sm:px-3 md:px-5 py-1 md:py-1.5 rounded-full transition-all shadow-sm">
                        Add
                      </button>
                      <span className="text-gray-400 text-[8px] sm:text-[10px]">Customize</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-8 md:mb-12">
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 md:px-6 py-2 rounded-full font-medium text-sm md:text-base transition-all whitespace-nowrap ${
              ...
              >
                ...
                <div className="p-3 md:p-5">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <a href={WA_LINK} target="_blank" rel="noopener noreferrer">
                      <Button size="sm" className="bg-pink-500 hover:bg-pink-600 text-white rounded-full py-1 px-2 md:px-4 text-xs md:text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group bg-cream-50 rounded-2xl p-6 md:p-8 hover:bg-white hover:shadow-card transition-all duration-300 border border-transparent hover:border-pink-100"
              >
                <div className="w-14 md:w-16 h-14 md:h-16 bg-gradient-to-br from-pink-100 to-pink-200 rounded-xl flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform">
                  <feature.icon className="w-6 md:w-8 h-6 md:h-8 text-pink-600" />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="space-y-3 md:space-y-5">
              ...
              {/* Instagram */}
              <a
                href="https://instagram.com/blisscake_official"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-3 md:gap-5 bg-white rounded-2xl p-4 md:p-5 shadow-soft hover:shadow-card transition-all duration-300 border border-transparent hover:border-pink-100"
              >
                <div className="w-12 md:w-14 h-12 md:h-14 rounded-2xl flex items-center justify-center flex-shrink-0"
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-bold text-gray-800 text-sm md:text-lg group-hover:text-pink-600 transition-colors truncate"
                  >@blisscake_official</p>
                  <p className="text-gray-500 text-xs md:text-sm">Follow us on Instagram • 12.4K Followers</p>
                </div>
                <div className="w-8 md:w-9 h-8 md:h-9 rounded-full bg-pink-50 group-hover:bg-pink-500 flex items-center justify-center transition-all flex-shrink-0">
                  <ChevronRight className="w-4 md:w-5 h-4 md:h-5 text-pink-400 group-hover:text-white transition-colors" />
                </div>
              </a>

              {/* Facebook */}
              <a
                href="https://facebook.com/blisscake"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-3 md:gap-5 bg-white rounded-2xl p-4 md:p-5 shadow-soft hover:shadow-card transition-all duration-300 border border-transparent hover:border-blue-100"
              >
                <div className="w-12 md:w-14 h-12 md:h-14 rounded-2xl bg-[#1877f2] flex items-center justify-center flex-shrink-0">
                  <Facebook className="w-6 md:w-7 h-6 md:h-7 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="font-bold text-gray-800 text-sm md:text-lg group-hover:text-blue-600 transition-colors truncate"
                  >Bliss Cake Official</p>
                  <p className="text-gray-500 text-xs md:text-sm">Like our Facebook page • 8.2K Likes</p>
                </div>
                <div className="w-8 md:w-9 h-8 md:h-9 rounded-full bg-blue-50 group-hover:bg-blue-500 flex items-center justify-center transition-all flex-shrink-0">
                  <ChevronRight className="w-4 md:w-5 h-4 md:h-5 text-blue-400 group-hover:text-white transition-colors" />
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-3 md:gap-5 bg-white rounded-2xl p-4 md:p-5 shadow-soft hover:shadow-card transition-all duration-300 border border-transparent hover:border-green-100"
              >
                <div className="w-12 md:w-14 h-12 md:h-14 rounded-2xl bg-[#25d366] flex items-center justify-center flex-shrink-0">
                  <MessageCircle className="w-6 md:w-7 h-6 md:h-7 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="font-bold text-gray-800 text-sm md:text-lg group-hover:text-green-600 transition-colors truncate"
                  >+91 74985 93746</p>
                  <p className="text-gray-500 text-xs md:text-sm">Chat with us on WhatsApp • Order anytime</p>
                </div>
                <div className="w-8 md:w-9 h-8 md:h-9 rounded-full bg-green-50 group-hover:bg-green-500 flex items-center justify-center transition-all flex-shrink-0">
                  <ChevronRight className="w-4 md:w-5 h-4 md:h-5 text-green-400 group-hover:text-white transition-colors" />
                </div>
              </a>

              {/* Tagline */}
              <p className="font-cursive text-pink-400 text-lg md:text-xl pl-2 pt-2">
                "Every cake tells a story — follow ours 🎂"
              </p>
            </div>
            {/* RIGHT — CSS Phone Mockup - Hidden on small screens */}
                    ...
                    <div className="px-4 py-3">
                      <div className="flex items-center gap-4 mb-3">
                        ...
                        <div className="flex gap-3 flex-1 justify-around text-center">
                          <div>
                            <p className="text-xs font-bold text-gray-900">348</p>
                          ...
                          <div>
                            <p className="text-xs font-bold text-gray-900">219</p>
      ...
      <footer id="footer" className="bg-gray-900 text-white py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4 md:mb-6">
                ...
                <span className="text-2xl md:text-3xl font-cursive font-bold bg-gradient-to-r from-pink-400 to-amber-400 bg-clip-text text-transparent">
                  Bliss Cake
                </span>
              </div>
              ...
              <p className="font-cursive text-amber-400 text-lg md:text-xl">
                Baked with love, delivered with joy.
              </p>
            </div>
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-lg font-semibold mb-4 md:mb-6">Quick Links</h4>
            ...
            {/* Contact */}
            <div>
              <h4 className="text-lg font-semibold mb-4 md:mb-6">Contact</h4>
          ...
          <div className="border-t border-gray-800 mt-8 md:mt-12 pt-6 md:pt-8 text-center text-gray-500 text-xs md:text-sm">
            <p className="font-cursive text-lg md:text-xl text-gray-400">Bliss Cake</p>
            <p className="mt-1">© 2026 Bliss Cake. All rights reserved.</p>
            <p className="mt-1">Made with ❤️ by the Bliss Cake Team</p>
          </div>
        </div>
      </footer>
